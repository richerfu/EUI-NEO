...
if(EUI_WINDOW_BACKEND STREQUAL "sdl3")
    ...
    if(TARGET SDL3::SDL3)
        message(STATUS "Using existing SDL3 target: SDL3::SDL3")
    elseif(EUI_DEPS_MODE STREQUAL "bundled")
        message(FATAL_ERROR
    ...
    elseif(EUI_DEPS_MODE STREQUAL "auto")
...
if(EUI_RESOLVED_RENDER_BACKEND STREQUAL "opengl")
    if(OHOS)
        if(NOT TARGET OpenGL::GL)
            add_library(eui_ohos_opengl INTERFACE)
            add_library(OpenGL::GL ALIAS eui_ohos_opengl)
            target_link_libraries(eui_ohos_opengl INTERFACE EGL GLESv3)
        endif()
    else()
        find_package(OpenGL QUIET)
    endif()
    if(NOT OHOS AND NOT OpenGL_FOUND)
        message(FATAL_ERROR
...
if(OHOS)
    eui_set_third_party_option(FT_DISABLE_PNG ON "Disable png support in bundled FreeType")
    eui_set_third_party_option(FT_REQUIRE_PNG OFF "Require png support in bundled FreeType")
else()
